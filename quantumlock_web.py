...
# -----------------------------
def show_homepage():
    st.image("https://media.istockphoto.com/id/1386179512/photo/computer-hacker-stealing-data-from-a-laptop.jpg?s=2048x2048&w=is&k=20&c=FHJY--2bDKL_TCOEcfBNxw59OiZIcThyw-WjZI417tw=", width=120)
...
def show_signup():
    ...
    if st.button("Create Account"):
        users = load_users()
        if not username or username_exists(users, username):
